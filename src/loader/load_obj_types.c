...
** Last update Tue Apr 19 01:48:13 2016 Ludovic Petrenko
*/

#include "raytracer.h"

void	load_sphere(t_obj *obj, t_bunny_ini_scope *scope)
{
  char	*tmp;
...
void	load_plane(t_obj *obj, t_bunny_ini_scope *scope)
{
  char	*tmp;
...
void	load_cylinder(t_obj *obj, t_bunny_ini_scope *scope)
{
  char	*tmp;
...
void	load_cone(t_obj *obj, t_bunny_ini_scope *scope)
{
  char	*tmp;
