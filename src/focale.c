...
** Last update Thu May 19 08:46:53 2016 Antoine Baché
*/
...
static void		new_gaussian_kernel(float *kernel[], int x, int y,
					    double sigma)
{
  int			i;
  int			j;
					   ...
					   t_bunny_pixelarray *work, int cur)
{
  ...
  new_gaussian_kernel((float **)kernel, 7, 7, data->scene->zbuf[cur]);
