...
** Last update Wed Apr 20 12:44:36 2016 Antoine Baché
*/
					...
					t_perlin_state state)
{
  ...
  simplex_calc_det(det, &dist_origin, grad, perm, &offset, 2);
  return (0.0);
}
					...
					t_perlin_state state)
{
  ...
  simplex_calc_det(det, &dist_origin, grad, perm, offset, 3);
